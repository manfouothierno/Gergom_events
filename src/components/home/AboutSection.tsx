                    ...
                    <div className="py-16"> {/* Keep padding */}
                        <div className="text-center mb-16">
                            {data.teamSectionTitle && ( // Use title from Sanity
                                <h2 className="text-3xl font-bold mb-6 text-white">{data.teamSectionTitle}</h2>
                            )}
                            {data.teamSectionDescription && ( // Use description from Sanity
                                <p className="text-xl text-gray-100 max-w-3xl mx-auto">{data.teamSectionDescription}</p>
                            )}
                        </div>
